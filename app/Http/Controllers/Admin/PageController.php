...
class PageController extends AdminController
{
  ...
  public function __construct(){
        ...
        \View::Share('layoutListUrl', route('admin.page.index'));
  }
    ...
    public function create(){
	    //show.
        return view('admins.pages.input',[
            'inputs' => [],
        ]);
    }
    ...
    public function store(PageRequest $request)
    {
        ...
        if ((!$request->input('end')) || (!empty($datas['errors']))){
            ...
            return redirect()->route('admin.page.index', ["mode" => "success", "is_coupon" => \Session::get("is_coupon")]);
        }
    }
    ...
    public function destroy($id){
      ...
      return redirect()->route('admin.page.index',['reflash' => 'destory']);
    }
